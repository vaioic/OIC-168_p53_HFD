...
/* PARAMETERS */
String channel = "CD45" // "HTX", "DAB", "Residual" for BF ; use channel name for FL ; "Average":Mean of all channels for BF/FL
double thresholdDownsample = 4 // 1:Full, 2:Very high, 4:High, 8:Moderate, 16:Low, 32:Very low, 64:Extremely low
String thresholdMethod = "Moments" // "Default", "Huang", "Intermodes", "IsoData", "IJ_IsoData", "Li", "MaxEntropy", "Mean", "MinError", "Minimum", "Moments", "Otsu", "Percentile", "RenyiEntropy", "Shanbhag", "Triangle", "Yen"
...
String classAbove = "CD45" // null or "Class Name"; use this for positive deconvoluted or fluorescence channels
...
selectAnnotations()
def annotations = getSelectedObjects().findAll{it.getPathClass() == getPathClass("Tissue")}
