...
def stardist = StarDist2D
    ...
    .pixelSize(0.32)              // Resolution for detection
...
def pathObjects = getAnnotationObjects().findAll{it.getPathClass() == getPathClass('Other')};
...
println('Done Running StarDist')
runObjectClassifier('Nuclei')
def false_nuc = getDetectionObjects().findAll{it.getPathClass() != getPathClass('Nuclei')}
removeObjects(false_nuc,true)
runObjectClassifier('CD45')